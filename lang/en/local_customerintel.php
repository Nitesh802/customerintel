...
$string['customerintel:admin'] = 'Administer CustomerIntel system';
...
$string['diagnostics_hub'] = 'Diagnostics & Health Hub';
$string['diagnostics'] = 'Diagnostics';
$string['run_doctor'] = 'Run Doctor';
$string['performance_trends'] = 'Performance Trends';
$string['trace_timeline'] = 'Trace Timeline';
$string['common_issues'] = 'Common Issues';
...
// Cache Decision Page - Milestone 0
$string['cache_decision_title'] = 'Intelligence Cache Manager';
$string['cache_decision_companies_header'] = 'Analysis Target';
$string['cache_decision_header'] = 'Cached Data Availability';
$string['source_company'] = 'Source Company';
$string['target_company'] = 'Target Company';
$string['cache_available_info'] = 'Cache Status';
$string['cache_not_available'] = 'No cached data available for this company pair.';
$string['cache_decision_label'] = 'How would you like to proceed?';
$string['cache_decision_reuse'] = 'Reuse Cached Data (~10 seconds)';
$string['cache_decision_full'] = 'Full Refresh (8-10 minutes)';
$string['cache_decision_reuse_help'] = 'Reuse: Copy Neural Block data from the most recent completed analysis. This is significantly faster but uses existing data. Full Refresh: Perform complete NB data collection from external sources. This takes longer but ensures the latest information.';
$string['cache_decision_full_help'] = 'A full refresh will fetch all 15 Neural Blocks from external sources. This provides the most current data but takes 8-10 minutes to complete.';
