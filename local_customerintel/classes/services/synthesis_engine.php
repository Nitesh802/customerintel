...
class CitationManager {
     ...
     */
    private function log_trace($runid, $phase, $message): void {
        // Only log if detailed trace logging is enabled
...
class synthesis_engine {
    ...
    public function build_report(int $runid, bool $force_regenerate = false): array {
        ...
        try {
            ...
            $this->log_trace($runid, 'orchestration', 'Orchestration start');
            ...
            $this->log_trace($runid, 'orchestration', 'Orchestration complete');
            ...
            $this->log_trace($runid, 'rebalancing', 'Rebalancing start');
            ...
            $this->log_trace($runid, 'rebalancing', 'Rebalancing complete');
            ...
            $this->log_trace($runid, 'validation', 'Validation start');
            ...
            try {
                ...
                if ($use_assembler_sections) {
                    ...
                    $this->log_trace($runid, 'drafting', 'Drafting start');
                    $sections = $this->draft_sections($patterns, $bridge, $inputs, $runid, $telemetry);
                    $this->log_trace($runid, 'drafting', 'Drafting complete');
            ...
            $this->log_trace($runid, 'bundle', 'Bundle creation start');
            $result = [
                'html' => $html_content,
                'json' => $json_content,
            ...
            $this->log_trace($runid, 'bundle', 'Bundle created');
